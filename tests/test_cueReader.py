...
class test_CueSheet(unittest.TestCase):
    ...
    def test_cuesheet_attributes(self):
        ...
        self.assertTrue(hasattr(self.test_cuesheet, 'exec_plan'))  
    
    def test_eval_line(self):
        dummy_performer_line = 'PERFORMER "John Doe"\n'
        tested_performer_line = \
            self.test_cuesheet.exec_plan['performer']
        self.assertEqual(
        ...
        album_title_regex = self.test_cuesheet.exec_plan['title']
        ...
        album_file_name_regex = \
            self.test_cuesheet.exec_plan['file']
        self.assertEqual(self.test_cuesheet.eval_line(
        ...
        album_track_beggining_regex = \
            self.test_cuesheet.exec_plan['track_beginning']
        self.assertEqual(self.test_cuesheet.eval_line(
            album_track_beggining_regex, 
